        ...
        "MemberDataCards.useEffect": ()=>{
            const getMembers = {
                "MemberDataCards.useEffect.getMembers": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$www$2f$SupabaseFetch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMembers"])();
                        setMembers(data);
                    } catch (error) {
                        console.error(error);
                    }
...
_s(MemberDataCards, "vkicIfJtsxnOItErHE0sT+V21Y0=");
_c = MemberDataCards;
...
//# sourceMappingURL=_4dd225f1._.js.map