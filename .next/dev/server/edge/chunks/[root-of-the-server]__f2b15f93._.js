...
async function middleware(request) {
    ...
    /* ---------- RULE 2 + 3: Protect admin routes ---------- */ if (pathname.startsWith("/admin-site")) {
        if (!session) {
    ...
    /* ---------- Optional safety: logged-in user shouldn't see login ---------- */ if (pathname === "/login" && session) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$28$2e$6_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/admin-site", request.url));
    }
    return response;
}
const config = {
